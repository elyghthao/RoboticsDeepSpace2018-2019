 ...
 *
 */
public class RunPistonMotorBackInfrared extends Command {
    ...
    public RunPistonMotorBackInfrared() {
    ...
    protected void initialize() {
        Robot.climbing.powerPistonMotor(1.0);
    ...
    protected boolean isFinished() {
        if(Robot.climbing.getBackInfrared() < 100){
            return true;
        }else{
        return false;
        }
