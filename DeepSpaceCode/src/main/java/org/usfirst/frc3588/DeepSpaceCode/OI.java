...
public class OI {
    ...
    public JoystickButton runPistonMotorButton;
    ...
    public OI() {
        ...
        runPistonMotorButton = new JoystickButton(rightJoystick, 7);
        runPistonMotorButton.whileHeld(new RunPistonMotor());
        ...
        SmartDashboard.putData("RunPistonMotor", new RunPistonMotor());
