...
public class OI {
    ...
    public JoystickButton toGameConfigButton;
    public JoystickButton toStartConfigButton;
    ...
    public OI() {
        ...
        toStartConfigButton = new JoystickButton(operatorJoystick, 12);
        toStartConfigButton.whileHeld(new ToStartConfig());
        toGameConfigButton = new JoystickButton(operatorJoystick, 11);
        toGameConfigButton.whileHeld(new ToGameConfig());
        ...
        SmartDashboard.putData("ToGameConfig", new ToGameConfig());
        SmartDashboard.putData("ToStartConfig", new ToStartConfig());
